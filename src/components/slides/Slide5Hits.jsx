      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 w-full max-w-6xl overflow-hidden px-4 md:px-0">
        {topRepos.map((repo, i) => (
           <motion.div
            ...
            className={`flex flex-col glass rounded-2xl md:rounded-3xl border border-white/10 overflow-hidden relative group hover:border-primary/50 transition-all ${i > 1 ? 'hidden md:flex' : 'flex'}`}
          >
            ...
            <div className="p-4 md:p-8 flex flex-col h-full text-left">
              ...
              <div className="flex items-center justify-between gap-2 mb-1 md:mb-2">
                <h3 className="text-lg md:text-2xl font-bold text-white truncate group-hover:text-primary transition-colors">
                  {repo.name}
                </h3>
              </div>
              ...
              <div className="mt-auto pt-4 md:pt-6 border-t border-white/5 flex items-center gap-4 md:gap-6">
                ...
                <div className="ml-auto">
                   <a 
                    ...
                    className="p-1 md:p-2 rounded-lg bg-white/5 hover:bg-primary/20 text-white/40 hover:text-primary transition-all active:scale-95 flex items-center justify-center"
